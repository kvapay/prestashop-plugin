...
<div class="box">
    ...
    <p>
        {l s='The payment has not yet been processed, below you can pay the order by cash on delivery.' mod='kvapay'}
    </p>
    ...
    <a class="btn btn-primary" href="{$kvapay_url_payment|escape:'htmlall':'UTF-8'}">{l s='Pay with cryptocurrency' mod='kvapay'}</a>
